...
import { ADJUST_LABEL, APPROVE_LABEL, REJECT_LABEL, RESULT_CARD_TOOL, REVIEW_QUESTION_ID, resolveReview, } from './contract.js';
        ...
        execute: async (args, exec) => {
            ...
            try {
                ...
                if (error instanceof UserQuestionError && error.code === 'ASK_CANCELLED') {
                    return { outcome: 'adjustment-requested', feedback: '用户关闭了审查卡片，准备通过普通消息补充意见。' };
                }
                throw error;
            }
        },
